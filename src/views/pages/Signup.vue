  ...
  <div class="h-screen flex flex-col items-center justify-center">
    ...
    >
      ...
      <div>
        ...
        <span
          v-if="
            v$.password_repeat.required.$invalid && v$.password_repeat.$dirty
          "
          class="block mt-3 text-red-500 text-xs font-semibold"
        >
        ...
        <span
          v-else-if="
            v$.password_repeat.sameAs.$invalid && v$.password_repeat.$dirty
          "
          class="block mt-3 text-red-500 text-xs font-semibold"
        >
      ...
      <div class="flex mt-6 justify-center text-xs">
        ...
        <router-link class="text-blue-400 hover:text-blue-500" to="/login"
          >Login</router-link
        >
      </div>
    </form>
    <p v-if="errorMessage" class="mt-4 text-red-600 text-semibold text-lg">
      {{ errorMessage }}
    </p>
  </div>
</template>
